...
const ChatWidget: React.FC = () => {
  ...
  useEffect(() => {
    console.log('💬 [ChatWidget] Translation stats:', {
    ...
    keysToCheck.forEach(key => {
      ...
      if (translation === key) {
        console.warn(`💬 [ChatWidget] Missing translation for: ${key}`);
      } else {
        console.log(`💬 [ChatWidget] Translation loaded for ${key}: "${translation}"`);
      }
    });
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        onClick={toggleChat}
        className={`fixed z-30 bottom-8 right-8 flex items-center justify-center w-16 h-16 rounded-full shadow-lg transition-colors ${
          isOpen ? "bg-bmw-red" : "bg-bmw-blue" 
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-4 flex items-center">
              <div className="relative w-10 h-10 mr-3 rounded-full overflow-hidden border-2 border-white flex items-center justify-center bg-white">
                <Image 
                  ...
                  alt={t('common.ca.international.aut')} 
                  width={32}
                  height={32}
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-lg">{t('common.ca.automotive.assist')}</h3>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-green-400 rounded-full mr-2 animate-pulse"></div>
                  <p className="text-xs opacity-90">{t('common.online.aipowered.sup')}</p>
                </div>
              </div>
            </div>
                    ...
                    >
                      {message.sender === 'ai' && (
                        <div className="flex items-center mb-1">
                          ...
                          <span className="text-xs font-semibold text-blue-500">{t('common.autobody.ai')}</span>
                        </div>
                      )}
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                aria-label={t('common.send.message')}
              >
                <IoMdSend size={18} />
              </motion.button>
            </motion.form>
